// 세션(오전/오후) 선택과 오늘 날짜를 표시하는 공통 헤더 — 티켓 스텁 스타일

import { getTodayInSeoul, formatDateLabel } from '@/lib/date';
...
export function Header({ session, onSessionChange, lastUpdated, actions }: HeaderProps) {
  const dateLabel = formatDateLabel(getTodayInSeoul());
